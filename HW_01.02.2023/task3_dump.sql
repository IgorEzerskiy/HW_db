...
1	Farrel	Colin	1976-05-31
2	Pitt	Brad	1963-12-18
3	Tennat	David	1971-04-18
\.
...
COPY public.films (film_id, films_name, director_last_name, director_first_name, release_year, imdb) FROM stdin;
...
SELECT pg_catalog.setval('public.films_film_id_seq', 2, true);
